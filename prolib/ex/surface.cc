...
void surface(int na, double *xv,double *radius,double *weight, double *area){
...
void rdpdb(string fn){
	...
	while(fgets(str, 200, fp) != NULL){
		...
		rads[na] = RADIUS_std[strs-ANAM_std];
		double *xt = x[na];
